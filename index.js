...
function addArtist(array) {
  const newObj = {
    id: 20,
    name: "Jessica Kitchen(Williams)", 
    years: "1994 - current day",
    genre: "Web Design", 
    nationality: "American",
    bio: "Jessica started web design in 2021 after looking for a career change. Her husband love programming and suggested she try it. She found that she enjoyed doing it and signed up for Lambda School."
  }
  array.push(newObj);
  return array;
}
